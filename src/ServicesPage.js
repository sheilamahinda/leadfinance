...
function ServicesPage() {
      ...
      <header>
        <nav className="navbar">
          ...
          <ul className="nav-links">
            ...
            <li><Link to="/profiles">Profile/Dashboard</Link></li>
          </ul>
  ...
  <div className="service-section alt-layout">
    ...
    <div className="content">
      ...
      <Link to="/budget-planner" className="button">Go to Budget Planner</Link>
    </div>
  </div>
  ...
  <div className="service-section">
    ...
    <div className="content">
      ...
      <Link to="/leadership-practice" className="button">Practice Leadership Skills</Link>
    </div>
  </div>
